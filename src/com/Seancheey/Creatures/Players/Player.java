...
public class Player extends Creature {
	...
	// image of the gun
	private static Image gunImage = Toolkit.getDefaultToolkit().getImage(
			"resource/Player/gun1.png");
	...
	public void paint(Graphics g) {
		...
		if (showGunTime > 0) {
			...
			g2d.rotate(gunRotation, GuiTool.fitWidth(getCenterPosition().x),
					GuiTool.fitHeight(getCenterPosition().y));
			g.drawImage(gunImage, GuiTool.fitWidth(getCenterPosition().x),
					GuiTool.fitHeight(getCenterPosition().y),
