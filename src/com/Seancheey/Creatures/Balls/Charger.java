	...
	public void makeMove() {
		...
		if (chargeTime <= 0) {
			...
			if (notifiedTime == 1000) {
				double angle = Math.atan2(TypeGetter.getPlayer(0)
						.getCenterPosition().y - getCenterPosition().y,
						TypeGetter.getPlayer(0).getCenterPosition().x
								- getCenterPosition().x);
			...
			v = 0.01;
			double angle = Math
					.atan2(TypeGetter.getPlayer(0).getCenterPosition().y
							- getCenterPosition().y, TypeGetter.getPlayer(0)
