...
public class GuiTool {
	...
	public static Dimension fitSize(Dimension originalSize) {
		return new Dimension((int) (originalSize.width
				* MainFrame.frameSize.width / 900), (int) (originalSize.height
				* MainFrame.frameSize.height / 600));
	}
	...
	public static Dimension getFittedSize(double ratio) {
		Dimension windowSize = new Dimension((int) (Toolkit.getDefaultToolkit()
				.getScreenSize().width * 0.85), (int) (Toolkit
		...
		if (windowSize.width == windowSize.height * ratio)
			...
			return new Dimension((int) (windowSize.height * ratio),
					windowSize.height);
		else if (windowSize.width < windowSize.height * ratio)
			return new Dimension(windowSize.width,
	...
	public static void setBounds(JComponent component, int px, int py,
	...
	public static Point convertPoint(Point originalPoint) {
		return new Point(
				(int) (originalPoint.x * MainFrame.frameSize.width / 900),
